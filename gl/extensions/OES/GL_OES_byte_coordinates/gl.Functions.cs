...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glMultiTexCoord1bvOES(GLenum texture, const GLbyte* coords)</summary>
        ...
        /// <summary>void glMultiTexCoord2bvOES(GLenum texture, const GLbyte* coords)</summary>
        ...
        /// <summary>void glMultiTexCoord3bvOES(GLenum texture, const GLbyte* coords)</summary>
        ...
        /// <summary>void glMultiTexCoord4bvOES(GLenum texture, const GLbyte* coords)</summary>
        ...
        /// <summary>void glTexCoord1bvOES(const GLbyte* coords)</summary>
        ...
        /// <summary>void glTexCoord2bvOES(const GLbyte* coords)</summary>
        ...
        /// <summary>void glTexCoord3bvOES(const GLbyte* coords)</summary>
        ...
        /// <summary>void glTexCoord4bvOES(const GLbyte* coords)</summary>
        ...
        /// <summary>void glVertex2bvOES(const GLbyte* coords)</summary>
        ...
        /// <summary>void glVertex3bvOES(const GLbyte* coords)</summary>
        ...
        /// <summary>void glVertex4bvOES(const GLbyte* coords)</summary>
