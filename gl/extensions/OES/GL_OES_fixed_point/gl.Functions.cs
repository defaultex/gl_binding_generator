...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glBitmapxOES(GLsizei width, GLsizei height, GLfixed xorig, GLfixed yorig, GLfixed xmove, GLfixed ymove, const GLubyte* bitmap)</summary>
        ...
        /// <summary>void glClipPlanexOES(GLenum plane, const GLfixed* equation)</summary>
        ...
        /// <summary>void glColor3xvOES(const GLfixed* components)</summary>
        ...
        /// <summary>void glColor4xvOES(const GLfixed* components)</summary>
        ...
        /// <summary>void glConvolutionParameterxvOES(GLenum target, GLenum pname, const GLfixed* params)</summary>
        ...
        /// <summary>void glEvalCoord1xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glEvalCoord2xvOES(const GLfixed* coords)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLfixed*, void> glEvalCoord2xvOES;

        /// <summary>void glFeedbackBufferxOES(GLsizei n, GLenum type, const GLfixed* buffer)</summary>
        ...
        /// <summary>void glFogxvOES(GLenum pname, const GLfixed* param)</summary>
        ...
        /// <summary>void glIndexxvOES(const GLfixed* component)</summary>
        ...
        /// <summary>void glLightModelxvOES(GLenum pname, const GLfixed* param)</summary>
        ...
        /// <summary>void glLightxvOES(GLenum light, GLenum pname, const GLfixed* params)</summary>
        ...
        /// <summary>void glLoadMatrixxOES(const GLfixed* m)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLfixed*, void> glLoadMatrixxOES;

        /// <summary>void glLoadTransposeMatrixxOES(const GLfixed* m)</summary>
        ...
        /// <summary>void glMaterialxvOES(GLenum face, GLenum pname, const GLfixed* param)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<MaterialFace, MaterialParameter, GLfixed*, void> glMaterialxvOES;

        /// <summary>void glMultMatrixxOES(const GLfixed* m)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLfixed*, void> glMultMatrixxOES;

        /// <summary>void glMultTransposeMatrixxOES(const GLfixed* m)</summary>
        ...
        /// <summary>void glMultiTexCoord1xvOES(GLenum texture, const GLfixed* coords)</summary>
        ...
        /// <summary>void glMultiTexCoord2xvOES(GLenum texture, const GLfixed* coords)</summary>
        ...
        /// <summary>void glMultiTexCoord3xvOES(GLenum texture, const GLfixed* coords)</summary>
        ...
        /// <summary>void glMultiTexCoord4xvOES(GLenum texture, const GLfixed* coords)</summary>
        ...
        /// <summary>void glNormal3xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glPixelMapx(GLenum map, GLint size, const GLfixed* values)</summary>
        ...
        /// <summary>void glPointParameterxvOES(GLenum pname, const GLfixed* params)</summary>
        ...
        /// <summary>void glPrioritizeTexturesxOES(GLsizei n, const GLuint* textures, const GLfixed* priorities)</summary>
        ...
        /// <summary>void glRasterPos2xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glRasterPos3xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glRasterPos4xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glRectxvOES(const GLfixed* v1, const GLfixed* v2)</summary>
        ...
        /// <summary>void glTexCoord1xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glTexCoord2xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glTexCoord3xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glTexCoord4xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glTexEnvxvOES(GLenum target, GLenum pname, const GLfixed* params)</summary>
        ...
        /// <summary>void glTexParameterxvOES(GLenum target, GLenum pname, const GLfixed* params)</summary>
        ...
        /// <summary>void glVertex2xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glVertex3xvOES(const GLfixed* coords)</summary>
        ...
        /// <summary>void glVertex4xvOES(const GLfixed* coords)</summary>
