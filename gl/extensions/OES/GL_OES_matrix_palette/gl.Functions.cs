...
public partial class gles1 { 
    public partial class Functions { 
        ...
        /// <summary>void glMatrixIndexPointerOES(GLint size, GLenum type, GLsizei stride, const void* pointer)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLint, MatrixIndexPointerTypeARB, GLsizei, void*, void> glMatrixIndexPointerOES;

        /// <summary>void glWeightPointerOES(GLint size, GLenum type, GLsizei stride, const void* pointer)</summary>
