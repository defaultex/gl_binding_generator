...
public enum BufferBitQCOM : GLenum {
    ColorBufferBit0Qcom = .Constants.GL_COLOR_BUFFER_BIT0_QCOM,
    ColorBufferBit1Qcom = .Constants.GL_COLOR_BUFFER_BIT1_QCOM,
    ColorBufferBit2Qcom = .Constants.GL_COLOR_BUFFER_BIT2_QCOM,
    ColorBufferBit3Qcom = .Constants.GL_COLOR_BUFFER_BIT3_QCOM,
    ColorBufferBit4Qcom = .Constants.GL_COLOR_BUFFER_BIT4_QCOM,
    ColorBufferBit5Qcom = .Constants.GL_COLOR_BUFFER_BIT5_QCOM,
    ColorBufferBit6Qcom = .Constants.GL_COLOR_BUFFER_BIT6_QCOM,
    ColorBufferBit7Qcom = .Constants.GL_COLOR_BUFFER_BIT7_QCOM,
    DepthBufferBit0Qcom = .Constants.GL_DEPTH_BUFFER_BIT0_QCOM,
    DepthBufferBit1Qcom = .Constants.GL_DEPTH_BUFFER_BIT1_QCOM,
    DepthBufferBit2Qcom = .Constants.GL_DEPTH_BUFFER_BIT2_QCOM,
    DepthBufferBit3Qcom = .Constants.GL_DEPTH_BUFFER_BIT3_QCOM,
    DepthBufferBit4Qcom = .Constants.GL_DEPTH_BUFFER_BIT4_QCOM,
    DepthBufferBit5Qcom = .Constants.GL_DEPTH_BUFFER_BIT5_QCOM,
    DepthBufferBit6Qcom = .Constants.GL_DEPTH_BUFFER_BIT6_QCOM,
    DepthBufferBit7Qcom = .Constants.GL_DEPTH_BUFFER_BIT7_QCOM,
    StencilBufferBit0Qcom = .Constants.GL_STENCIL_BUFFER_BIT0_QCOM,
    StencilBufferBit1Qcom = .Constants.GL_STENCIL_BUFFER_BIT1_QCOM,
    StencilBufferBit2Qcom = .Constants.GL_STENCIL_BUFFER_BIT2_QCOM,
    StencilBufferBit3Qcom = .Constants.GL_STENCIL_BUFFER_BIT3_QCOM,
    StencilBufferBit4Qcom = .Constants.GL_STENCIL_BUFFER_BIT4_QCOM,
    StencilBufferBit5Qcom = .Constants.GL_STENCIL_BUFFER_BIT5_QCOM,
    StencilBufferBit6Qcom = .Constants.GL_STENCIL_BUFFER_BIT6_QCOM,
    StencilBufferBit7Qcom = .Constants.GL_STENCIL_BUFFER_BIT7_QCOM,
    MultisampleBufferBit0Qcom = .Constants.GL_MULTISAMPLE_BUFFER_BIT0_QCOM,
    MultisampleBufferBit1Qcom = .Constants.GL_MULTISAMPLE_BUFFER_BIT1_QCOM,
    MultisampleBufferBit2Qcom = .Constants.GL_MULTISAMPLE_BUFFER_BIT2_QCOM,
    MultisampleBufferBit3Qcom = .Constants.GL_MULTISAMPLE_BUFFER_BIT3_QCOM,
    MultisampleBufferBit4Qcom = .Constants.GL_MULTISAMPLE_BUFFER_BIT4_QCOM,
    MultisampleBufferBit5Qcom = .Constants.GL_MULTISAMPLE_BUFFER_BIT5_QCOM,
    MultisampleBufferBit6Qcom = .Constants.GL_MULTISAMPLE_BUFFER_BIT6_QCOM,
    MultisampleBufferBit7Qcom = .Constants.GL_MULTISAMPLE_BUFFER_BIT7_QCOM,
    ColorBufferBit0Qcom = .Constants.GL_COLOR_BUFFER_BIT0_QCOM,
    ColorBufferBit1Qcom = .Constants.GL_COLOR_BUFFER_BIT1_QCOM,
    ColorBufferBit2Qcom = .Constants.GL_COLOR_BUFFER_BIT2_QCOM,
    ColorBufferBit3Qcom = .Constants.GL_COLOR_BUFFER_BIT3_QCOM,
