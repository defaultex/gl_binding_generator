...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glProgramEnvParameterI4ivNV(GLenum target, GLuint index, const GLint* params)</summary>
        ...
        /// <summary>void glProgramEnvParameterI4uivNV(GLenum target, GLuint index, const GLuint* params)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<ProgramTarget, GLuint, GLuint*, void> glProgramEnvParameterI4uivNV;

        /// <summary>void glProgramEnvParametersI4ivNV(GLenum target, GLuint index, GLsizei count, const GLint* params)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<ProgramTarget, GLuint, GLsizei, GLint*, void> glProgramEnvParametersI4ivNV;

        /// <summary>void glProgramEnvParametersI4uivNV(GLenum target, GLuint index, GLsizei count, const GLuint* params)</summary>
        ...
        /// <summary>void glProgramLocalParameterI4ivNV(GLenum target, GLuint index, const GLint* params)</summary>
        ...
        /// <summary>void glProgramLocalParameterI4uivNV(GLenum target, GLuint index, const GLuint* params)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<ProgramTarget, GLuint, GLuint*, void> glProgramLocalParameterI4uivNV;

        /// <summary>void glProgramLocalParametersI4ivNV(GLenum target, GLuint index, GLsizei count, const GLint* params)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<ProgramTarget, GLuint, GLsizei, GLint*, void> glProgramLocalParametersI4ivNV;

        /// <summary>void glProgramLocalParametersI4uivNV(GLenum target, GLuint index, GLsizei count, const GLuint* params)</summary>
