...
public partial class gles2 { 
    public partial class Functions { 
        /// <summary>void glDepthRangeArrayfvNV(GLuint first, GLsizei count, const GLfloat* v)</summary>
        ...
        /// <summary>void glScissorArrayvNV(GLuint first, GLsizei count, const GLint* v)</summary>
        ...
        /// <summary>void glScissorIndexedvNV(GLuint index, const GLint* v)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLuint, GLint*, void> glScissorIndexedvNV;

        /// <summary>void glViewportArrayvNV(GLuint first, GLsizei count, const GLfloat* v)</summary>
        ...
        /// <summary>void glViewportIndexedfvNV(GLuint index, const GLfloat* v)</summary>
