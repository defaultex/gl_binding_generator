...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glMulticastBufferSubDataNV(GLbitfield gpuMask, GLuint buffer, GLintptr offset, GLsizeiptr size, const void* data)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLbitfield, GLbuffer, GLintptr, GLsizeiptr, void*, void> glMulticastBufferSubDataNV;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<GLuint, GLbitfield, GLbuffer, GLbuffer, GLintptr, GLintptr, GLsizeiptr, void> glMulticastCopyBufferSubDataNV;
        ...
        /// <summary>void glMulticastFramebufferSampleLocationsfvNV(GLuint gpu, GLuint framebuffer, GLuint start, GLsizei count, const GLfloat* v)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLuint, GLframebuffer, GLuint, GLsizei, GLfloat*, void> glMulticastFramebufferSampleLocationsfvNV;
