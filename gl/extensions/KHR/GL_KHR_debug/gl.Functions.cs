...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glDebugMessageCallbackKHR(GLDEBUGPROCKHR callback, const void* userParam)</summary>
        ...
        /// <summary>void glDebugMessageControlKHR(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint* ids, GLboolean enabled)</summary>
        ...
        /// <summary>void glDebugMessageInsertKHR(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* buf)</summary>
        ...
        /// <summary>void glGetObjectPtrLabelKHR(const void* ptr, GLsizei bufSize, GLsizei* length, GLchar* label)</summary>
        ...
        /// <summary>void glObjectLabelKHR(GLenum identifier, GLuint name, GLsizei length, const GLchar* label)</summary>
        ...
        /// <summary>void glObjectPtrLabelKHR(const void* ptr, GLsizei length, const GLchar* label)</summary>
        ...
        /// <summary>void glPushDebugGroupKHR(GLenum source, GLuint id, GLsizei length, const GLchar* message)</summary>
