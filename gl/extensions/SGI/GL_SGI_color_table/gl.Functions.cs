...
public partial class gl { 
    public partial class Functions { 
        /// <summary>void glColorTableParameterfvSGI(GLenum target, GLenum pname, const GLfloat* params)</summary>
        ...
        /// <summary>void glColorTableParameterivSGI(GLenum target, GLenum pname, const GLint* params)</summary>
        ...
        /// <summary>void glColorTableSGI(GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const void* table)</summary>
