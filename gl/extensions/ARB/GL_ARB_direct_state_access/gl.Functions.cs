...
public partial class gl { 
    public partial class Functions { 
        ...
        public static unsafe delegate* unmanaged[Cdecl]<GLframebuffer, FramebufferTarget, GLenum> glCheckNamedFramebufferStatus;

        /// <summary>void glClearNamedBufferData(GLuint buffer, GLenum internalformat, GLenum format, GLenum type, const void* data)</summary>
        ...
        /// <summary>void glClearNamedBufferSubData(GLuint buffer, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const void* data)</summary>
        ...
        /// <summary>void glClearNamedFramebufferfv(GLuint framebuffer, GLenum buffer, GLint drawbuffer, const GLfloat* value)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLframebuffer, Buffer, GLint, GLfloat*, void> glClearNamedFramebufferfv;

        /// <summary>void glClearNamedFramebufferiv(GLuint framebuffer, GLenum buffer, GLint drawbuffer, const GLint* value)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLframebuffer, Buffer, GLint, GLint*, void> glClearNamedFramebufferiv;

        /// <summary>void glClearNamedFramebufferuiv(GLuint framebuffer, GLenum buffer, GLint drawbuffer, const GLuint* value)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLframebuffer, Buffer, GLint, GLuint*, void> glClearNamedFramebufferuiv;

        /// <summary>void glCompressedTextureSubImage1D(GLuint texture, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void* data)</summary>
        ...
        /// <summary>void glCompressedTextureSubImage2D(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void* data)</summary>
        ...
        /// <summary>void glCompressedTextureSubImage3D(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void* data)</summary>
        ...
        /// <summary>void glInvalidateNamedFramebufferData(GLuint framebuffer, GLsizei numAttachments, const GLenum* attachments)</summary>
        ...
        /// <summary>void glInvalidateNamedFramebufferSubData(GLuint framebuffer, GLsizei numAttachments, const GLenum* attachments, GLint x, GLint y, GLsizei width, GLsizei height)</summary>
        ...
        /// <summary>void glNamedBufferData(GLuint buffer, GLsizeiptr size, const void* data, GLenum usage)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLbuffer, GLsizeiptr, void*, VertexBufferObjectUsage, void> glNamedBufferData;

        /// <summary>void glNamedBufferStorage(GLuint buffer, GLsizeiptr size, const void* data, GLbitfield flags)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLbuffer, GLsizeiptr, void*, BufferStorageMask, void> glNamedBufferStorage;

        /// <summary>void glNamedBufferSubData(GLuint buffer, GLintptr offset, GLsizeiptr size, const void* data)</summary>
        ...
        /// <summary>void glNamedFramebufferDrawBuffers(GLuint framebuffer, GLsizei n, const GLenum* bufs)</summary>
        ...
        /// <summary>void glTextureParameterIiv(GLuint texture, GLenum pname, const GLint* params)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLtexture, TextureParameterName, GLint*, void> glTextureParameterIiv;

        /// <summary>void glTextureParameterIuiv(GLuint texture, GLenum pname, const GLuint* params)</summary>
        ...
        /// <summary>void glTextureParameterfv(GLuint texture, GLenum pname, const GLfloat* param)</summary>
        ...
        /// <summary>void glTextureParameteriv(GLuint texture, GLenum pname, const GLint* param)</summary>
        ...
        /// <summary>void glTextureSubImage1D(GLuint texture, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void* pixels)</summary>
        ...
        /// <summary>void glTextureSubImage2D(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void* pixels)</summary>
        ...
        /// <summary>void glTextureSubImage3D(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void* pixels)</summary>
        ...
        /// <summary>void glVertexArrayVertexBuffers(GLuint vaobj, GLuint first, GLsizei count, const GLuint* buffers, const GLintptr* offsets, const GLsizei* strides)</summary>
