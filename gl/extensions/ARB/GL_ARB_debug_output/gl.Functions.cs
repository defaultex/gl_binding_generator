...
public partial class gl { 
    public partial class Functions { 
        /// <summary>void glDebugMessageCallbackARB(GLDEBUGPROCARB callback, const void* userParam)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLDEBUGPROCARB, void*, void> glDebugMessageCallbackARB;

        /// <summary>void glDebugMessageControlARB(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint* ids, GLboolean enabled)</summary>
        ...
        /// <summary>void glDebugMessageInsertARB(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* buf)</summary>
