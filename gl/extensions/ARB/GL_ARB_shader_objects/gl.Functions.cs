...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>GLint glGetUniformLocationARB(GLhandleARB programObj, const GLcharARB* name)</summary>
        ...
        /// <summary>void glShaderSourceARB(GLhandleARB shaderObj, GLsizei count, const GLcharARB** string, const GLint* length)</summary>
        ...
        /// <summary>void glUniform1fvARB(GLint location, GLsizei count, const GLfloat* value)</summary>
        ...
        /// <summary>void glUniform1ivARB(GLint location, GLsizei count, const GLint* value)</summary>
        ...
        /// <summary>void glUniform2fvARB(GLint location, GLsizei count, const GLfloat* value)</summary>
        ...
        /// <summary>void glUniform2ivARB(GLint location, GLsizei count, const GLint* value)</summary>
        ...
        /// <summary>void glUniform3fvARB(GLint location, GLsizei count, const GLfloat* value)</summary>
        ...
        /// <summary>void glUniform3ivARB(GLint location, GLsizei count, const GLint* value)</summary>
        ...
        /// <summary>void glUniform4fvARB(GLint location, GLsizei count, const GLfloat* value)</summary>
        ...
        /// <summary>void glUniform4ivARB(GLint location, GLsizei count, const GLint* value)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLint, GLsizei, GLint*, void> glUniform4ivARB;

        /// <summary>void glUniformMatrix2fvARB(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLint, GLsizei, GLboolean, GLfloat*, void> glUniformMatrix2fvARB;

        /// <summary>void glUniformMatrix3fvARB(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLint, GLsizei, GLboolean, GLfloat*, void> glUniformMatrix3fvARB;

        /// <summary>void glUniformMatrix4fvARB(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value)</summary>
