...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glBufferDataARB(GLenum target, GLsizeiptrARB size, const void* data, GLenum usage)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<BufferTargetARB, GLsizeiptrARB, void*, BufferUsageARB, void> glBufferDataARB;

        /// <summary>void glBufferSubDataARB(GLenum target, GLintptrARB offset, GLsizeiptrARB size, const void* data)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<BufferTargetARB, GLintptrARB, GLsizeiptrARB, void*, void> glBufferSubDataARB;

        /// <summary>void glDeleteBuffersARB(GLsizei n, const GLuint* buffers)</summary>
