...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glColorSubTable(GLenum target, GLsizei start, GLsizei count, GLenum format, GLenum type, const void* data)</summary>
        ...
        /// <summary>void glColorTable(GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const void* table)</summary>
        ...
        /// <summary>void glColorTableParameterfv(GLenum target, GLenum pname, const GLfloat* params)</summary>
        ...
        /// <summary>void glColorTableParameteriv(GLenum target, GLenum pname, const GLint* params)</summary>
        ...
        /// <summary>void glConvolutionFilter1D(GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const void* image)</summary>
        ...
        /// <summary>void glConvolutionFilter2D(GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const void* image)</summary>
        ...
        /// <summary>void glConvolutionParameterfv(GLenum target, GLenum pname, const GLfloat* params)</summary>
        ...
        /// <summary>void glConvolutionParameteriv(GLenum target, GLenum pname, const GLint* params)</summary>
        ...
        /// <summary>void glSeparableFilter2D(GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const void* row, const void* column)</summary>
