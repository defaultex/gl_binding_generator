...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glWindowPos2dvARB(const GLdouble* v)</summary>
        ...
        /// <summary>void glWindowPos2fvARB(const GLfloat* v)</summary>
        ...
        /// <summary>void glWindowPos2ivARB(const GLint* v)</summary>
        ...
        /// <summary>void glWindowPos2svARB(const GLshort* v)</summary>
        ...
        /// <summary>void glWindowPos3dvARB(const GLdouble* v)</summary>
        ...
        /// <summary>void glWindowPos3fvARB(const GLfloat* v)</summary>
        ...
        /// <summary>void glWindowPos3ivARB(const GLint* v)</summary>
        ...
        /// <summary>void glWindowPos3svARB(const GLshort* v)</summary>
