...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glListParameterfvSGIX(GLuint list, GLenum pname, const GLfloat* params)</summary>
        ...
        /// <summary>void glListParameterivSGIX(GLuint list, GLenum pname, const GLint* params)</summary>
