...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glSetInvariantEXT(GLuint id, GLenum type, const void* addr)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLuint, ScalarType, void*, void> glSetInvariantEXT;

        /// <summary>void glSetLocalConstantEXT(GLuint id, GLenum type, const void* addr)</summary>
