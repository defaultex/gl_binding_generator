...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glVertexAttribL1dvEXT(GLuint index, const GLdouble* v)</summary>
        ...
        /// <summary>void glVertexAttribL2dvEXT(GLuint index, const GLdouble* v)</summary>
        ...
        /// <summary>void glVertexAttribL3dvEXT(GLuint index, const GLdouble* v)</summary>
        ...
        /// <summary>void glVertexAttribL4dvEXT(GLuint index, const GLdouble* v)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLuint, GLdouble*, void> glVertexAttribL4dvEXT;

        /// <summary>void glVertexAttribLPointerEXT(GLuint index, GLint size, GLenum type, GLsizei stride, const void* pointer)</summary>
