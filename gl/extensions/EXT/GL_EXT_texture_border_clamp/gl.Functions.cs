...
public partial class gles2 { 
    public partial class Functions { 
        ...
        /// <summary>void glSamplerParameterIivEXT(GLuint sampler, GLenum pname, const GLint* param)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLsampler, SamplerParameterI, GLint*, void> glSamplerParameterIivEXT;

        /// <summary>void glSamplerParameterIuivEXT(GLuint sampler, GLenum pname, const GLuint* param)</summary>
