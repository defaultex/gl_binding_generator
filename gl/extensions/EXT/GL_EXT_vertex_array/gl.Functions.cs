...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glColorPointerEXT(GLint size, GLenum type, GLsizei stride, GLsizei count, const void* pointer)</summary>
        ...
        /// <summary>void glEdgeFlagPointerEXT(GLsizei stride, GLsizei count, const GLboolean* pointer)</summary>
        ...
        /// <summary>void glIndexPointerEXT(GLenum type, GLsizei stride, GLsizei count, const void* pointer)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<IndexPointerType, GLsizei, GLsizei, void*, void> glIndexPointerEXT;

        /// <summary>void glNormalPointerEXT(GLenum type, GLsizei stride, GLsizei count, const void* pointer)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<NormalPointerType, GLsizei, GLsizei, void*, void> glNormalPointerEXT;

        /// <summary>void glTexCoordPointerEXT(GLint size, GLenum type, GLsizei stride, GLsizei count, const void* pointer)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLint, TexCoordPointerType, GLsizei, GLsizei, void*, void> glTexCoordPointerEXT;

        /// <summary>void glVertexPointerEXT(GLint size, GLenum type, GLsizei stride, GLsizei count, const void* pointer)</summary>
