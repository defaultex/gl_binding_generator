...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glSecondaryColor3bvEXT(const GLbyte* v)</summary>
        ...
        /// <summary>void glSecondaryColor3dvEXT(const GLdouble* v)</summary>
        ...
        /// <summary>void glSecondaryColor3fvEXT(const GLfloat* v)</summary>
        ...
        /// <summary>void glSecondaryColor3ivEXT(const GLint* v)</summary>
        ...
        /// <summary>void glSecondaryColor3svEXT(const GLshort* v)</summary>
        ...
        /// <summary>void glSecondaryColor3ubvEXT(const GLubyte* v)</summary>
        ...
        /// <summary>void glSecondaryColor3uivEXT(const GLuint* v)</summary>
        ...
        /// <summary>void glSecondaryColor3usvEXT(const GLushort* v)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLushort*, void> glSecondaryColor3usvEXT;

        /// <summary>void glSecondaryColorPointerEXT(GLint size, GLenum type, GLsizei stride, const void* pointer)</summary>
