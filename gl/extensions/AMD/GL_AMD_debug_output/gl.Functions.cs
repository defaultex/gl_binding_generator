...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glDebugMessageEnableAMD(GLenum category, GLenum severity, GLsizei count, const GLuint* ids, GLboolean enabled)</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLenum, DebugSeverity, GLsizei, GLuint*, GLboolean, void> glDebugMessageEnableAMD;

        /// <summary>void glDebugMessageInsertAMD(GLenum category, GLenum severity, GLuint id, GLsizei length, const GLchar* buf)</summary>
