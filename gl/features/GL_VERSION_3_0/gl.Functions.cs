public partial class gl { 
    public partial class Functions { 
        ...
        public static unsafe delegate* unmanaged[Cdecl]<GLuint, VertexAttribProperty, GLint*, void> glGetVertexAttribIiv;

        /// <summary>void glGetVertexAttribIuiv(GLuint index, GLenum pname, GLuint* params);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLuint, VertexAttribProperty, GLuint*, void> glGetVertexAttribIuiv;
