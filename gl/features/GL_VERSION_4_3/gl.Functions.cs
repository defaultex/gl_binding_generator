public partial class gl { 
    public partial class Functions { 
        ...
        public static unsafe delegate* unmanaged[Cdecl]<BufferTarget, SizedInternalFormat, PixelFormat, PixelType, void*, void> glClearBufferData;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<BufferTarget, SizedInternalFormat, GLintptr, GLsizeiptr, PixelFormat, PixelType, void*, void> glClearBufferSubData;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<GLuint, ImageSubDataTarget, GLint, GLint, GLint, GLint, GLuint, ImageSubDataTarget, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, void> glCopyImageSubData;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<FramebufferTarget, FramebufferParameter, GLint, void> glFramebufferParameteri;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<FramebufferTarget, FramebufferAttachmentParameter, GLint*, void> glGetFramebufferParameteriv;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<TextureTarget, InternalFormat, InternalFormatParameter, GLsizei, GLint64*, void> glGetInternalformati64v;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<GLprogram, ProgramInterface, ProgramInterfaceParameter, GLint*, void> glGetProgramInterfaceiv;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<FramebufferTarget, GLsizei, FramebufferAttachment*, void> glInvalidateFramebuffer;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<FramebufferTarget, GLsizei, FramebufferAttachment*, GLint, GLint, GLsizei, GLsizei, void> glInvalidateSubFramebuffer;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<PrimitiveType, ElementType, void*, GLsizei, GLsizei, void> glMultiDrawElementsIndirect;
        ...
        public static unsafe delegate* unmanaged[Cdecl]<GLuint, GLint, VertexAttribType, GLuint, void> glVertexAttribIFormat;

        /// <summary>void glVertexAttribLFormat(GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLuint, GLint, VertexAttribType, GLuint, void> glVertexAttribLFormat;
