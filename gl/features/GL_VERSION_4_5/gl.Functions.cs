...
public partial class gl { 
    public partial class Functions { 
        ...
        /// <summary>void glGetnColorTable(GLenum target, GLenum format, GLenum type, GLsizei bufSize, void* table);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<ColorTableTarget, PixelFormat, PixelType, GLsizei, void*, void> glGetnColorTable;
        ...
        /// <summary>void glGetnConvolutionFilter(GLenum target, GLenum format, GLenum type, GLsizei bufSize, void* image);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<ConvolutionTarget, PixelFormat, PixelType, GLsizei, void*, void> glGetnConvolutionFilter;

        /// <summary>void glGetnHistogram(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void* values);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<HistogramTarget, GLboolean, PixelFormat, PixelType, GLsizei, void*, void> glGetnHistogram;

        /// <summary>void glGetnMapdv(GLenum target, GLenum query, GLsizei bufSize, GLdouble* v);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<MapTarget, MapQuery, GLsizei, GLdouble*, void> glGetnMapdv;

        /// <summary>void glGetnMapfv(GLenum target, GLenum query, GLsizei bufSize, GLfloat* v);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<MapTarget, MapQuery, GLsizei, GLfloat*, void> glGetnMapfv;

        /// <summary>void glGetnMapiv(GLenum target, GLenum query, GLsizei bufSize, GLint* v);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<MapTarget, MapQuery, GLsizei, GLint*, void> glGetnMapiv;

        /// <summary>void glGetnMinmax(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void* values);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<MinmaxTarget, GLboolean, PixelFormat, PixelType, GLsizei, void*, void> glGetnMinmax;

        /// <summary>void glGetnPixelMapfv(GLenum map, GLsizei bufSize, GLfloat* values);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<PixelMap, GLsizei, GLfloat*, void> glGetnPixelMapfv;

        /// <summary>void glGetnPixelMapuiv(GLenum map, GLsizei bufSize, GLuint* values);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<PixelMap, GLsizei, GLuint*, void> glGetnPixelMapuiv;

        /// <summary>void glGetnPixelMapusv(GLenum map, GLsizei bufSize, GLushort* values);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<PixelMap, GLsizei, GLushort*, void> glGetnPixelMapusv;

        /// <summary>void glGetnPolygonStipple(GLsizei bufSize, GLubyte* pattern);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<GLsizei, GLubyte*, void> glGetnPolygonStipple;

        /// <summary>void glGetnSeparableFilter(GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, void* row, GLsizei columnBufSize, void* column, void* span);</summary>
        public static unsafe delegate* unmanaged[Cdecl]<SeparableTarget, PixelFormat, PixelType, GLsizei, void*, GLsizei, void*, void*, void> glGetnSeparableFilter;
