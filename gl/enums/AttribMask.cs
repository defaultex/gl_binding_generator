...
public enum AttribMask : GLbitfield {
    ...
    Multisample = .Constants.GL_MULTISAMPLE_BIT,
    MultisampleBitArb = .Constants.GL_MULTISAMPLE_BIT_ARB,
    MultisampleBitExt = .Constants.GL_MULTISAMPLE_BIT_EXT,
    MultisampleBit3dfx = .Constants.GL_MULTISAMPLE_BIT_3DFX,
    AllAttrib = .Constants.GL_ALL_ATTRIB_BITS,
    Current = .Constants.GL_CURRENT_BIT,
    Point = .Constants.GL_POINT_BIT,
    Line = .Constants.GL_LINE_BIT,
    Polygon = .Constants.GL_POLYGON_BIT,
