...
public enum EnableCap : GLenum {
    ...
    ClipDistance0 = .Constants.GL_CLIP_DISTANCE0,
    ClipPlane1 = .Constants.GL_CLIP_PLANE1,
    ClipDistance1 = .Constants.GL_CLIP_DISTANCE1,
    ClipPlane2 = .Constants.GL_CLIP_PLANE2,
    ClipDistance2 = .Constants.GL_CLIP_DISTANCE2,
    ClipPlane3 = .Constants.GL_CLIP_PLANE3,
    ClipDistance3 = .Constants.GL_CLIP_DISTANCE3,
    ClipPlane4 = .Constants.GL_CLIP_PLANE4,
    ClipDistance4 = .Constants.GL_CLIP_DISTANCE4,
    ClipPlane5 = .Constants.GL_CLIP_PLANE5,
    ClipDistance5 = .Constants.GL_CLIP_DISTANCE5,
    ClipDistance6 = .Constants.GL_CLIP_DISTANCE6,
    ClipDistance7 = .Constants.GL_CLIP_DISTANCE7,
    ...
    DebugOutputSynchronous = .Constants.GL_DEBUG_OUTPUT_SYNCHRONOUS,
    ...
    FragmentLight1Sgix = .Constants.GL_FRAGMENT_LIGHT1_SGIX,
    FragmentLight2Sgix = .Constants.GL_FRAGMENT_LIGHT2_SGIX,
    FragmentLight3Sgix = .Constants.GL_FRAGMENT_LIGHT3_SGIX,
    FragmentLight4Sgix = .Constants.GL_FRAGMENT_LIGHT4_SGIX,
    FragmentLight5Sgix = .Constants.GL_FRAGMENT_LIGHT5_SGIX,
    FragmentLight6Sgix = .Constants.GL_FRAGMENT_LIGHT6_SGIX,
    FragmentLight7Sgix = .Constants.GL_FRAGMENT_LIGHT7_SGIX,
    TextureRectangle = .Constants.GL_TEXTURE_RECTANGLE,
    TextureRectangleArb = .Constants.GL_TEXTURE_RECTANGLE_ARB,
    TextureRectangleNv = .Constants.GL_TEXTURE_RECTANGLE_NV,
    TextureCubeMap = .Constants.GL_TEXTURE_CUBE_MAP,
    TextureCubeMapArb = .Constants.GL_TEXTURE_CUBE_MAP_ARB,
    TextureCubeMapExt = .Constants.GL_TEXTURE_CUBE_MAP_EXT,
    TextureCubeMapOes = .Constants.GL_TEXTURE_CUBE_MAP_OES,
    ProgramPointSize = .Constants.GL_PROGRAM_POINT_SIZE,
    DepthClamp = .Constants.GL_DEPTH_CLAMP,
    TextureCubeMapSeamless = .Constants.GL_TEXTURE_CUBE_MAP_SEAMLESS,
    SampleShading = .Constants.GL_SAMPLE_SHADING,
    RasterizerDiscard = .Constants.GL_RASTERIZER_DISCARD,
    PrimitiveRestartFixedIndex = .Constants.GL_PRIMITIVE_RESTART_FIXED_INDEX,
    FramebufferSrgb = .Constants.GL_FRAMEBUFFER_SRGB,
    SampleMask = .Constants.GL_SAMPLE_MASK,
    FetchPerSampleArm = .Constants.GL_FETCH_PER_SAMPLE_ARM,
    PrimitiveRestart = .Constants.GL_PRIMITIVE_RESTART,
    DebugOutput = .Constants.GL_DEBUG_OUTPUT,
    ShadingRateImagePerPrimitiveNv = .Constants.GL_SHADING_RATE_IMAGE_PER_PRIMITIVE_NV,
    ShadingRatePreserveAspectRatioQcom = .Constants.GL_SHADING_RATE_PRESERVE_ASPECT_RATIO_QCOM,
}
