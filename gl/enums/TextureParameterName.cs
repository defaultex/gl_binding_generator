...
public enum TextureParameterName : GLenum {
    TextureWidth = .Constants.GL_TEXTURE_WIDTH,
    TextureHeight = .Constants.GL_TEXTURE_HEIGHT,
    TextureInternalFormat = .Constants.GL_TEXTURE_INTERNAL_FORMAT,
    TextureComponents = .Constants.GL_TEXTURE_COMPONENTS,
    TextureBorderColor = .Constants.GL_TEXTURE_BORDER_COLOR,
    TextureBorderColorNv = .Constants.GL_TEXTURE_BORDER_COLOR_NV,
    TextureBorder = .Constants.GL_TEXTURE_BORDER,
    TextureMagFilter = .Constants.GL_TEXTURE_MAG_FILTER,
    TextureMinFilter = .Constants.GL_TEXTURE_MIN_FILTER,
    TextureWrap = .Constants.GL_TEXTURE_WRAP_S,
    TextureWrap = .Constants.GL_TEXTURE_WRAP_T,
    TextureRedSize = .Constants.GL_TEXTURE_RED_SIZE,
    TextureGreenSize = .Constants.GL_TEXTURE_GREEN_SIZE,
    TextureBlueSize = .Constants.GL_TEXTURE_BLUE_SIZE,
    TextureAlphaSize = .Constants.GL_TEXTURE_ALPHA_SIZE,
    TextureLuminanceSize = .Constants.GL_TEXTURE_LUMINANCE_SIZE,
    TextureIntensitySize = .Constants.GL_TEXTURE_INTENSITY_SIZE,
    TexturePriority = .Constants.GL_TEXTURE_PRIORITY,
    TexturePriorityExt = .Constants.GL_TEXTURE_PRIORITY_EXT,
    TextureResident = .Constants.GL_TEXTURE_RESIDENT,
    TextureDepthExt = .Constants.GL_TEXTURE_DEPTH_EXT,
    TextureWrapR = .Constants.GL_TEXTURE_WRAP_R,
    TextureWrapRExt = .Constants.GL_TEXTURE_WRAP_R_EXT,
    TextureWrapROes = .Constants.GL_TEXTURE_WRAP_R_OES,
    DetailTextureLevelSgis = .Constants.GL_DETAIL_TEXTURE_LEVEL_SGIS,
    DetailTextureModeSgis = .Constants.GL_DETAIL_TEXTURE_MODE_SGIS,
    DetailTextureFuncPointsSgis = .Constants.GL_DETAIL_TEXTURE_FUNC_POINTS_SGIS,
    SharpenTextureFuncPointsSgis = .Constants.GL_SHARPEN_TEXTURE_FUNC_POINTS_SGIS,
    ShadowAmbientSgix = .Constants.GL_SHADOW_AMBIENT_SGIX,
    DualTextureSelectSgis = .Constants.GL_DUAL_TEXTURE_SELECT_SGIS,
    QuadTextureSelectSgis = .Constants.GL_QUAD_TEXTURE_SELECT_SGIS,
    Texture4dsizeSgis = .Constants.GL_TEXTURE_4DSIZE_SGIS,
    TextureWrapQSgis = .Constants.GL_TEXTURE_WRAP_Q_SGIS,
    TextureMinLod = .Constants.GL_TEXTURE_MIN_LOD,
    TextureMinLodSgis = .Constants.GL_TEXTURE_MIN_LOD_SGIS,
    TextureMaxLod = .Constants.GL_TEXTURE_MAX_LOD,
    TextureMaxLodSgis = .Constants.GL_TEXTURE_MAX_LOD_SGIS,
    TextureBaseLevel = .Constants.GL_TEXTURE_BASE_LEVEL,
    TextureBaseLevelSgis = .Constants.GL_TEXTURE_BASE_LEVEL_SGIS,
    TextureMaxLevel = .Constants.GL_TEXTURE_MAX_LEVEL,
    TextureMaxLevelSgis = .Constants.GL_TEXTURE_MAX_LEVEL_SGIS,
    TextureFilter4SizeSgis = .Constants.GL_TEXTURE_FILTER4_SIZE_SGIS,
    TextureClipmapCenterSgix = .Constants.GL_TEXTURE_CLIPMAP_CENTER_SGIX,
    TextureClipmapFrameSgix = .Constants.GL_TEXTURE_CLIPMAP_FRAME_SGIX,
    TextureClipmapOffsetSgix = .Constants.GL_TEXTURE_CLIPMAP_OFFSET_SGIX,
    TextureClipmapVirtualDepthSgix = .Constants.GL_TEXTURE_CLIPMAP_VIRTUAL_DEPTH_SGIX,
    TextureClipmapLodOffsetSgix = .Constants.GL_TEXTURE_CLIPMAP_LOD_OFFSET_SGIX,
    TextureClipmapDepthSgix = .Constants.GL_TEXTURE_CLIPMAP_DEPTH_SGIX,
    PostTextureFilterBiasSgix = .Constants.GL_POST_TEXTURE_FILTER_BIAS_SGIX,
    PostTextureFilterScaleSgix = .Constants.GL_POST_TEXTURE_FILTER_SCALE_SGIX,
    TextureLodBiasSSgix = .Constants.GL_TEXTURE_LOD_BIAS_S_SGIX,
    TextureLodBiasTSgix = .Constants.GL_TEXTURE_LOD_BIAS_T_SGIX,
    TextureLodBiasRSgix = .Constants.GL_TEXTURE_LOD_BIAS_R_SGIX,
    GenerateMipmap = .Constants.GL_GENERATE_MIPMAP,
    GenerateMipmapSgis = .Constants.GL_GENERATE_MIPMAP_SGIS,
    TextureCompareSgix = .Constants.GL_TEXTURE_COMPARE_SGIX,
    TextureCompareOperatorSgix = .Constants.GL_TEXTURE_COMPARE_OPERATOR_SGIX,
    TextureLequalRSgix = .Constants.GL_TEXTURE_LEQUAL_R_SGIX,
    TextureGequalRSgix = .Constants.GL_TEXTURE_GEQUAL_R_SGIX,
    TextureMaxClampSSgix = .Constants.GL_TEXTURE_MAX_CLAMP_S_SGIX,
    TextureMaxClampTSgix = .Constants.GL_TEXTURE_MAX_CLAMP_T_SGIX,
    TextureMaxClampRSgix = .Constants.GL_TEXTURE_MAX_CLAMP_R_SGIX,
    TextureMaxAnisotropy = .Constants.GL_TEXTURE_MAX_ANISOTROPY,
    TextureLodBias = .Constants.GL_TEXTURE_LOD_BIAS,
    TextureCompareMode = .Constants.GL_TEXTURE_COMPARE_MODE,
    TextureCompareFunc = .Constants.GL_TEXTURE_COMPARE_FUNC,
    TextureSwizzleR = .Constants.GL_TEXTURE_SWIZZLE_R,
    TextureSwizzleG = .Constants.GL_TEXTURE_SWIZZLE_G,
    TextureSwizzle = .Constants.GL_TEXTURE_SWIZZLE_B,
    TextureSwizzleA = .Constants.GL_TEXTURE_SWIZZLE_A,
    TextureSwizzleRgba = .Constants.GL_TEXTURE_SWIZZLE_RGBA,
    TextureUnnormalizedCoordinatesArm = .Constants.GL_TEXTURE_UNNORMALIZED_COORDINATES_ARM,
    DepthStencilTextureMode = .Constants.GL_DEPTH_STENCIL_TEXTURE_MODE,
    TextureTilingExt = .Constants.GL_TEXTURE_TILING_EXT,
    TextureFoveatedCutoffDensityQcom = .Constants.GL_TEXTURE_FOVEATED_CUTOFF_DENSITY_QCOM,
}
