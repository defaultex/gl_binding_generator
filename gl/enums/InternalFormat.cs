#if (GL_ANGLE_DEPTH_TEXTURE || GL_ES_VERSION_2_0 || GL_OES_DEPTH_TEXTURE || GL_VERSION_1_0 || GL_SC_VERSION_2_0 || GL_VERSION_ES_CM_1_0 || GL_VERSION_1_1 || GL_VERSION_1_4 || GL_ARB_FRAMEBUFFER_OBJECT || GL_ARB_TEXTURE_STENCIL8 || GL_ES_VERSION_3_2 || GL_VERSION_3_0 || GL_VERSION_4_4 || GL_ARB_ES2_COMPATIBILITY || GL_VERSION_4_1 || GL_AMD_INTERLEAVED_ELEMENTS || GL_ES_VERSION_3_0 || GL_ARB_TEXTURE_RG || GL_ARB_TEXTURE_BUFFER_OBJECT_RGB32 || GL_VERSION_2_1 || GL_ARB_DEPTH_BUFFER_FLOAT || GL_ARB_VERTEX_ATTRIB_64BIT || GL_EXT_RENDER_SNORM || GL_EXT_TEXTURE_SNORM || GL_VERSION_3_1 || GL_ARB_TEXTURE_RGB10_A2UI || GL_VERSION_3_3 || GL_ARB_ES3_COMPATIBILITY || GL_VERSION_4_3 || GL_ES_VERSION_3_1 || GL_VERSION_1_3 || GL_ARB_TEXTURE_COMPRESSION_RGTC || GL_VERSION_4_2 || GL_OES_DEPTH32 || GL_OES_REQUIRED_INTERNALFORMAT || GL_OES_PACKED_DEPTH_STENCIL || GL_ANGLE_TEXTURE_COMPRESSION_DXT3 || GL_ANGLE_TEXTURE_COMPRESSION_DXT5 || GL_APPLE_TEXTURE_PACKED_FLOAT || GL_ARB_DEPTH_TEXTURE || GL_ARB_TEXTURE_COMPRESSION_BPTC || GL_ARB_TEXTURE_FLOAT || GL_EXT_COLOR_BUFFER_HALF_FLOAT || GL_EXT_TEXTURE_STORAGE || GL_EXT_FRAMEBUFFER_OBJECT || GL_EXT_PACKED_DEPTH_STENCIL || GL_EXT_PACKED_FLOAT || GL_EXT_TEXTURE_NORM16 || GL_EXT_SRGB || GL_EXT_TEXTURE_SRGB || GL_EXT_TEXTURE || GL_EXT_TEXTURE_COMPRESSION_BPTC || GL_EXT_TEXTURE_COMPRESSION_DXT1 || GL_EXT_TEXTURE_COMPRESSION_S3TC || GL_EXT_TEXTURE_COMPRESSION_RGTC || GL_EXT_TEXTURE_COMPRESSION_S3TC_SRGB || GL_EXT_TEXTURE_INTEGER || GL_EXT_TEXTURE_RG || GL_EXT_TEXTURE_SHARED_EXPONENT || GL_EXT_TEXTURE_SRGB_R8 || GL_EXT_TEXTURE_SRGB_RG8 || GL_KHR_TEXTURE_COMPRESSION_ASTC_HDR || GL_KHR_TEXTURE_COMPRESSION_ASTC_LDR || GL_OES_TEXTURE_COMPRESSION_ASTC || GL_NV_DEPTH_BUFFER_FLOAT || GL_NV_PACKED_DEPTH_STENCIL || GL_NV_SRGB_FORMATS || GL_OES_COMPRESSED_ETC1_RGB8_TEXTURE || GL_OES_DEPTH24 || GL_OES_FRAMEBUFFER_OBJECT || GL_OES_RGB8_RGBA8 || GL_OES_STENCIL1 || GL_OES_STENCIL4 || GL_OES_STENCIL8 || GL_OES_TEXTURE_STENCIL8 || GL_SGIS_TEXTURE_SELECT || GL_SGIX_DEPTH_TEXTURE)
...
public enum InternalFormat : GLenum { 
...
#if (GL_ANGLE_DEPTH_TEXTURE || GL_OES_PACKED_DEPTH_STENCIL)
    DepthStencilOes = gl.Constants.GL_DEPTH_STENCIL_OES, 
#endif
    ...
    DepthStencilExt = gl.Constants.GL_DEPTH_STENCIL_EXT, 
#endif
    ...
    SrgbExt = gl.Constants.GL_SRGB_EXT, 
#endif

#if (GL_EXT_SRGB || GL_EXT_TEXTURE_SRGB)
    SrgbAlphaExt = gl.Constants.GL_SRGB_ALPHA_EXT, 
#endif
    ...
    DepthStencilNv = gl.Constants.GL_DEPTH_STENCIL_NV, 
#endif
    ...
    StencilIndexOes = gl.Constants.GL_STENCIL_INDEX_OES, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualAlpha4Sgis = gl.Constants.GL_DUAL_ALPHA4_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualAlpha8Sgis = gl.Constants.GL_DUAL_ALPHA8_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualAlpha12Sgis = gl.Constants.GL_DUAL_ALPHA12_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualAlpha16Sgis = gl.Constants.GL_DUAL_ALPHA16_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualLuminance4Sgis = gl.Constants.GL_DUAL_LUMINANCE4_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualLuminance8Sgis = gl.Constants.GL_DUAL_LUMINANCE8_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualLuminance12Sgis = gl.Constants.GL_DUAL_LUMINANCE12_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualLuminance16Sgis = gl.Constants.GL_DUAL_LUMINANCE16_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualIntensity4Sgis = gl.Constants.GL_DUAL_INTENSITY4_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualIntensity8Sgis = gl.Constants.GL_DUAL_INTENSITY8_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualIntensity12Sgis = gl.Constants.GL_DUAL_INTENSITY12_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualIntensity16Sgis = gl.Constants.GL_DUAL_INTENSITY16_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualLuminanceAlpha4Sgis = gl.Constants.GL_DUAL_LUMINANCE_ALPHA4_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    DualLuminanceAlpha8Sgis = gl.Constants.GL_DUAL_LUMINANCE_ALPHA8_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    QuadAlpha4Sgis = gl.Constants.GL_QUAD_ALPHA4_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    QuadAlpha8Sgis = gl.Constants.GL_QUAD_ALPHA8_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    QuadLuminance4Sgis = gl.Constants.GL_QUAD_LUMINANCE4_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    QuadLuminance8Sgis = gl.Constants.GL_QUAD_LUMINANCE8_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    QuadIntensity4Sgis = gl.Constants.GL_QUAD_INTENSITY4_SGIS, 
#endif

#if GL_SGIS_TEXTURE_SELECT
    QuadIntensity8Sgis = gl.Constants.GL_QUAD_INTENSITY8_SGIS, 
#endif
