...
public enum InternalFormatPName : GLenum {
    ...
    InternalformatSupported = .Constants.GL_INTERNALFORMAT_SUPPORTED,
    InternalformatPreferred = .Constants.GL_INTERNALFORMAT_PREFERRED,
    InternalformatRedSize = .Constants.GL_INTERNALFORMAT_RED_SIZE,
    InternalformatGreenSize = .Constants.GL_INTERNALFORMAT_GREEN_SIZE,
    InternalformatBlueSize = .Constants.GL_INTERNALFORMAT_BLUE_SIZE,
    InternalformatAlphaSize = .Constants.GL_INTERNALFORMAT_ALPHA_SIZE,
    InternalformatDepthSize = .Constants.GL_INTERNALFORMAT_DEPTH_SIZE,
    InternalformatStencilSize = .Constants.GL_INTERNALFORMAT_STENCIL_SIZE,
    InternalformatSharedSize = .Constants.GL_INTERNALFORMAT_SHARED_SIZE,
    InternalformatRedType = .Constants.GL_INTERNALFORMAT_RED_TYPE,
    InternalformatGreenType = .Constants.GL_INTERNALFORMAT_GREEN_TYPE,
    InternalformatBlueType = .Constants.GL_INTERNALFORMAT_BLUE_TYPE,
    InternalformatAlphaType = .Constants.GL_INTERNALFORMAT_ALPHA_TYPE,
    InternalformatDepthType = .Constants.GL_INTERNALFORMAT_DEPTH_TYPE,
    InternalformatStencilType = .Constants.GL_INTERNALFORMAT_STENCIL_TYPE,
    MaxWidth = .Constants.GL_MAX_WIDTH,
    MaxHeight = .Constants.GL_MAX_HEIGHT,
    MaxDepth = .Constants.GL_MAX_DEPTH,
    MaxLayers = .Constants.GL_MAX_LAYERS,
    ColorComponents = .Constants.GL_COLOR_COMPONENTS,
    ColorRenderable = .Constants.GL_COLOR_RENDERABLE,
    DepthRenderable = .Constants.GL_DEPTH_RENDERABLE,
    StencilRenderable = .Constants.GL_STENCIL_RENDERABLE,
    FramebufferRenderable = .Constants.GL_FRAMEBUFFER_RENDERABLE,
    FramebufferRenderableLayered = .Constants.GL_FRAMEBUFFER_RENDERABLE_LAYERED,
    FramebufferBlend = .Constants.GL_FRAMEBUFFER_BLEND,
    ReadPixels = .Constants.GL_READ_PIXELS,
    ReadPixelsFormat = .Constants.GL_READ_PIXELS_FORMAT,
    ReadPixelsType = .Constants.GL_READ_PIXELS_TYPE,
    TextureImageFormat = .Constants.GL_TEXTURE_IMAGE_FORMAT,
    TextureImageType = .Constants.GL_TEXTURE_IMAGE_TYPE,
    GetTextureImageFormat = .Constants.GL_GET_TEXTURE_IMAGE_FORMAT,
    GetTextureImageType = .Constants.GL_GET_TEXTURE_IMAGE_TYPE,
    Mipmap = .Constants.GL_MIPMAP,
    AutoGenerateMipmap = .Constants.GL_AUTO_GENERATE_MIPMAP,
    ColorEncoding = .Constants.GL_COLOR_ENCODING,
    SrgbRead = .Constants.GL_SRGB_READ,
    SrgbWrite = .Constants.GL_SRGB_WRITE,
    Filter = .Constants.GL_FILTER,
    VertexTexture = .Constants.GL_VERTEX_TEXTURE,
    TessControlTexture = .Constants.GL_TESS_CONTROL_TEXTURE,
    TessEvaluationTexture = .Constants.GL_TESS_EVALUATION_TEXTURE,
    GeometryTexture = .Constants.GL_GEOMETRY_TEXTURE,
    FragmentTexture = .Constants.GL_FRAGMENT_TEXTURE,
    ComputeTexture = .Constants.GL_COMPUTE_TEXTURE,
    TextureShadow = .Constants.GL_TEXTURE_SHADOW,
    TextureGather = .Constants.GL_TEXTURE_GATHER,
    TextureGatherShadow = .Constants.GL_TEXTURE_GATHER_SHADOW,
    ShaderImageLoad = .Constants.GL_SHADER_IMAGE_LOAD,
    ShaderImageStore = .Constants.GL_SHADER_IMAGE_STORE,
    ShaderImageAtomic = .Constants.GL_SHADER_IMAGE_ATOMIC,
    ImageTexelSize = .Constants.GL_IMAGE_TEXEL_SIZE,
    ImageCompatibilityClass = .Constants.GL_IMAGE_COMPATIBILITY_CLASS,
    ImagePixelFormat = .Constants.GL_IMAGE_PIXEL_FORMAT,
    ImagePixelType = .Constants.GL_IMAGE_PIXEL_TYPE,
    SimultaneousTextureAndDepthTest = .Constants.GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_TEST,
    SimultaneousTextureAndStencilTest = .Constants.GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_TEST,
    SimultaneousTextureAndDepthWrite = .Constants.GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_WRITE,
    SimultaneousTextureAndStencilWrite = .Constants.GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_WRITE,
    TextureCompressedBlockWidth = .Constants.GL_TEXTURE_COMPRESSED_BLOCK_WIDTH,
    TextureCompressedBlockHeight = .Constants.GL_TEXTURE_COMPRESSED_BLOCK_HEIGHT,
    TextureCompressedBlockSize = .Constants.GL_TEXTURE_COMPRESSED_BLOCK_SIZE,
    ClearBuffer = .Constants.GL_CLEAR_BUFFER,
    TextureView = .Constants.GL_TEXTURE_VIEW,
    ViewCompatibilityClass = .Constants.GL_VIEW_COMPATIBILITY_CLASS,
    TextureCompressed = .Constants.GL_TEXTURE_COMPRESSED,
    NumSurfaceCompressionFixedRatesExt = .Constants.GL_NUM_SURFACE_COMPRESSION_FIXED_RATES_EXT,
    ImageFormatCompatibilityType = .Constants.GL_IMAGE_FORMAT_COMPATIBILITY_TYPE,
    ClearTexture = .Constants.GL_CLEAR_TEXTURE,
    NumSampleCounts = .Constants.GL_NUM_SAMPLE_COUNTS,
}
