...
public enum MemoryBarrierMask : GLbitfield {
    VertexAttribArrayBarrier = .Constants.GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT,
    VertexAttribArrayBarrierBitExt = .Constants.GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT_EXT,
    ElementArrayBarrier = .Constants.GL_ELEMENT_ARRAY_BARRIER_BIT,
    ElementArrayBarrierBitExt = .Constants.GL_ELEMENT_ARRAY_BARRIER_BIT_EXT,
    UniformBarrier = .Constants.GL_UNIFORM_BARRIER_BIT,
    UniformBarrierBitExt = .Constants.GL_UNIFORM_BARRIER_BIT_EXT,
    TextureFetchBarrier = .Constants.GL_TEXTURE_FETCH_BARRIER_BIT,
    TextureFetchBarrierBitExt = .Constants.GL_TEXTURE_FETCH_BARRIER_BIT_EXT,
    ShaderGlobalAccessBarrierBitNv = .Constants.GL_SHADER_GLOBAL_ACCESS_BARRIER_BIT_NV,
    ShaderImageAccessBarrier = .Constants.GL_SHADER_IMAGE_ACCESS_BARRIER_BIT,
    ShaderImageAccessBarrierBitExt = .Constants.GL_SHADER_IMAGE_ACCESS_BARRIER_BIT_EXT,
    CommandBarrier = .Constants.GL_COMMAND_BARRIER_BIT,
    CommandBarrierBitExt = .Constants.GL_COMMAND_BARRIER_BIT_EXT,
    PixelBufferBarrier = .Constants.GL_PIXEL_BUFFER_BARRIER_BIT,
    PixelBufferBarrierBitExt = .Constants.GL_PIXEL_BUFFER_BARRIER_BIT_EXT,
    TextureUpdateBarrier = .Constants.GL_TEXTURE_UPDATE_BARRIER_BIT,
    TextureUpdateBarrierBitExt = .Constants.GL_TEXTURE_UPDATE_BARRIER_BIT_EXT,
    BufferUpdateBarrier = .Constants.GL_BUFFER_UPDATE_BARRIER_BIT,
    BufferUpdateBarrierBitExt = .Constants.GL_BUFFER_UPDATE_BARRIER_BIT_EXT,
    FramebufferBarrier = .Constants.GL_FRAMEBUFFER_BARRIER_BIT,
    FramebufferBarrierBitExt = .Constants.GL_FRAMEBUFFER_BARRIER_BIT_EXT,
    TransformFeedbackBarrier = .Constants.GL_TRANSFORM_FEEDBACK_BARRIER_BIT,
    TransformFeedbackBarrierBitExt = .Constants.GL_TRANSFORM_FEEDBACK_BARRIER_BIT_EXT,
    AtomicCounterBarrier = .Constants.GL_ATOMIC_COUNTER_BARRIER_BIT,
    AtomicCounterBarrierBitExt = .Constants.GL_ATOMIC_COUNTER_BARRIER_BIT_EXT,
    ShaderStorageBarrier = .Constants.GL_SHADER_STORAGE_BARRIER_BIT,
    ClientMappedBufferBarrier = .Constants.GL_CLIENT_MAPPED_BUFFER_BARRIER_BIT,
    ClientMappedBufferBarrierBitExt = .Constants.GL_CLIENT_MAPPED_BUFFER_BARRIER_BIT_EXT,
    QueryBufferBarrier = .Constants.GL_QUERY_BUFFER_BARRIER_BIT,
    AllBarrier = .Constants.GL_ALL_BARRIER_BITS,
    AllBarrierBitsExt = .Constants.GL_ALL_BARRIER_BITS_EXT,
    VertexAttribArrayBarrier = .Constants.GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT,
    VertexAttribArrayBarrierBitExt = .Constants.GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT_EXT,
    ElementArrayBarrier = .Constants.GL_ELEMENT_ARRAY_BARRIER_BIT,
    ElementArrayBarrierBitExt = .Constants.GL_ELEMENT_ARRAY_BARRIER_BIT_EXT,
